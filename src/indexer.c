...
{
	const struct _entry *entrya = a;
	const struct _entry *entryb = b;
...
static int save_entry(git_indexer *idx, struct _entry *entry, struct git_pack_entry *pentry, off64_t entry_start)
{
	int i;
